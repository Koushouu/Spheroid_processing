...
##################################### Inputs ###########################################################################
cell_stats_npy = r"C:\Users\CBC\PycharmProjects\pythonProject\spheroid\cell_stats_parallel_mask.npy"
coordname = 'allcells_bright_mask.csv'
########################################################################################################################
# Load data
...
plt.hist(nanoptl_int_array, 150)
plt.show()
...
coord = np.transpose([z_loc, y_loc, x_loc])
